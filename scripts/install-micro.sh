#!/usr/bin/env bash
# Install the justly-*-micro agents + commands (the lean variants) into ~/.claude
# (global) or a project's .claude (local). No clone required — downloads this repo's
# tarball from GitHub. This is the default installer.
#
